...
export function NoticeSection() {
  ...
  return (
    <section
      className="relative min-h-[100dvh] flex items-center justify-center bg-white text-black py-20"
      id="notice-section"
    >
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-gray-50/50 to-gray-100/30" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <p className="text-lg md:text-xl text-gray-700 mb-4 leading-relaxed">
            ...
            <strong className="text-black text-2xl md:text-3xl">
              시네마틱 프로필
            </strong>
            <em>{" "}예약 페이지입니다.</em>
          </p>
          ...
          <div className="space-y-4 text-gray-800 mt-8">
            ...
            <p className="text-lg leading-relaxed">
              ...
              프로필 사진을 촬영하는{" "}
              <br className="md:hidden" />
              <strong className="text-black">선셋시네마 팀</strong>입니다.
            </p>
          </div>

          <div className="bg-gray-50 backdrop-blur-sm rounded-lg p-6 mt-8 border border-gray-200 shadow-sm">
        ...
        {/* Booking Process */}
        <div className="mb-16">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 md:p-8 border border-blue-200 shadow-sm">
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <p>
                * 문의량이 많아 <strong className="text-black">영업일 기준</strong> 순서대로 응대를
        ...
        <div className="mb-16">
          ...
          <div className="bg-red-50 rounded-lg p-4 md:p-6 border border-red-200 shadow-sm">
            <div className="space-y-4">
              ...
              <div>
                <p className="text-gray-700">
                  <strong className="text-red-600">촬영 취소:</strong> 촬영일
        ...
        <div className="text-center space-y-6 mb-16">
          <div className="space-y-4">
            <Button
              ...
              size="lg"
              className="bg-black text-white hover:bg-gray-800 transition-colors w-full md:w-auto"
            >
              촬영 예약하기
